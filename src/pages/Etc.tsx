...
const Etc = () => (
  <PageWrapper>
    ...
    <p>
      ...
      <a href={"https://github.com/phineas/phineas.io"}>phineas/phineas.io</a>
    </p>
    <h2>Contact</h2>
    <p>
      I'm most responsive through Twitter DMs, you can{" "}
      <a href={"https://twitter.com/messages/compose?recipient_id=102583719"}>
        click here
      </a>{" "}
      to DM me on Twitter.
    </p>
    ...
    <ul>
      ...
      <li>
        PGP Fingerprint:{" "}
        <code>D740 E413 3A74 815E F5B6 F11B AF8B EE0C CF1D 0E46</code>
      </li>
      <li>
        Primary ETH Address:{" "}
